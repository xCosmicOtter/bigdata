...
def display_graph_and_tabs(values, n_clicks_log, n_clicks_bollinger, graphType, time_period, class_name_log, class_name_bollinger):
    if n_clicks_log:
        if 'toggle-on' in class_name_log:
            class_name_log = 'toggle-button toggle-off'
        else:
            class_name_log = 'toggle-button toggle-on'

    if n_clicks_bollinger:
        if 'toggle-on' in class_name_bollinger:
            class_name_bollinger = 'toggle-button toggle-off'
        else:
            class_name_bollinger = 'toggle-button toggle-on'
